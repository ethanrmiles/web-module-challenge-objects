...
createMenuItem('cortado', 4, 'coffee');
createMenuItem('espresso tonic', 5, 'coffee');
createMenuItem('americano', 4, 'coffee')
...
const burger = {
  ...
  discount: function(person){
    if(person === 'teacher' || person === 'student'){
      ...
      return 'no discount for you, go back to where you came from.'
    }
  }
}
...
console.log('task 2', burger.discount('alien'));
